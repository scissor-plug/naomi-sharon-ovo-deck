...
<svelte:head>
	...
	<meta
		name="description"
		content="Naomi Sharon · OVO — naomisharon.com overhaul invoice with MOWA: Mowalola creative direction $2,000 + $1,000 pre-MOWA rebuild including LUAR/Raimundo-style CMS admin editor; illustrative timeline TBD with label milestones."
	/>
</svelte:head>
